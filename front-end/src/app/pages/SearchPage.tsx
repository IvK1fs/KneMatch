...
const allMovies: Movie[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1655367574486-f63675dd69eb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaW5lbWElMjBtb3ZpZSUyMHBvc3RlcnxlbnwxfHx8fDE3NzUwMTE4NjN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    year: 2024,
    genre: 'Ação',
    rating: 9.2,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1554246881-d1aec048cc39?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhY3Rpb24lMjBmaWxtJTIwc2NlbmV8ZW58MXx8fHwxNzc1MDU4OTIxfDA&ixlib=rb-4.1.0&q=80&w=1080',
    year: 2023,
    genre: 'Drama',
    rating: 9.0,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1762356121454-877acbd554bb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkcmFtYSUyMG1vdmllJTIwdGhlYXRlcnxlbnwxfHx8fDE3NzUwNTg5MjF8MA&ixlib=rb-4.1.0&q=80&w=1080',
    year: 2024,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1764197944213-3beb56dcf9b4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21lZHklMjBmaWxtJTIwZW50ZXJ0YWlubWVudHxlbnwxfHx8fDE3NzUwNTg5MjF8MA&ixlib=rb-4.1.0&q=80&w=1080',
    year: 2025,
    genre: 'Comédia',
    rating: 8.4,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1634585738250-09ee92cae0f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzY2ktZmklMjBtb3ZpZSUyMGZ1dHVyaXN0aWN8ZW58MXx8fHwxNzc1MDA5MDg5fDA&ixlib=rb-4.1.0&q=80&w=1080',
    year: 2024,
    genre: 'Ficção Científica',
    rating: 9.4,
  ...
  },
  {
    id: 6,
    title: 'Amor Eterno',
    image: 'https://images.unsplash.com/photo-1705565535316-3e4cc538c2ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyb21hbmNlJTIwZmlsbSUyMGNvdXBsZXxlbnwxfHx8fDE3NzUwNTg5MjJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
    year: 2023,
    genre: 'Romance',
    rating: 8.6,
    actors: ['Zendaya', 'Emma Stone'],
  },
  {
    id: 7,
    ...
    genre: 'Ação',
    rating: 8.2,
    actors: ['Ryan Reynolds', 'Tom Hanks'],
  },
  {
    id: 8,
    ...
    genre: 'Suspense',
    rating: 8.0,
    actors: ['Meryl Streep', 'Zoe Saldana'],
  },
  {
    id: 9,
    ...
    genre: 'Comédia',
    rating: 7.8,
    actors: ['Emma Stone', 'Ryan Reynolds'],
  },
  {
    id: 10,
    title: 'Destino Final',
...
export function SearchPage() {
  ...
  const filteredMovies = allMovies.filter((movie) => {
    ...
    const matchesActor =
      actorName === '' || 
      movie.actors.some((actor) => actor.toLowerCase().includes(actorName.toLowerCase()));
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-4 mt-6">
            <Button
              ...
              variant="outline"
              className="border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 gap-2"
            >
              <Filter className="w-4 h-4" />
              {t('search.filters')}
              {activeFiltersCount > 0 && (
                <Badge className="bg-red-600 ml-2">{activeFiltersCount}</Badge>
              )}
            </Button>
            ...
            {activeFiltersCount > 0 && (
              <Button
                ...
                variant="ghost"
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-800 gap-2"
              >
                <X className="w-4 h-4" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {sortedMovies.map((movie) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h3 className="text-gray-900 dark:text-white mb-2 line-clamp-1 group-hover:text-red-500 transition-colors">
                        {movie.title}
                      </h3>
                      ...
                      <Badge variant="outline" className="border-gray-400 dark:border-gray-700 text-gray-600 dark:text-gray-400 text-xs">
                        {movie.genre}
                      </Badge>
                    </div>
                  </div>
