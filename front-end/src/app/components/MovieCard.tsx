...
//mudanças feitas visando melhorar a apresentação dos filmes
...
export function MovieCard({ title, image, rating, year, genre }: MovieCardProps) {
  return (
    // Garante largura fixa e que não encolhe
    <div className="group relative overflow-hidden rounded-lg transition-transform hover:scale-105 cursor-pointer shadow-md dark:shadow-none w-full h-full flex flex-col">
      {/* Container da imagem com proporção fixa 2:3 */}
